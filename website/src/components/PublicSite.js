...
export default function PublicSite() {
  return <main className="ns-site">
    ...
    <footer className="ns-footer"><Wordmark /><div><a href="mailto:support@cmameet.site">support@cmameet.site</a><span aria-hidden="true">·</span><Link to="/privacy">Privacy</Link><span aria-hidden="true">·</span><Link to="/terms">Terms</Link><span aria-hidden="true">·</span><Link to="/admin">Admin</Link><span aria-hidden="true">·</span><a href={CMA_DIRECTORY} target="_blank" rel="noreferrer">Official CMA <ExternalLink size={13} aria-hidden="true" /></a></div><p>© 2026 Northstar. Support address shown for future support requests.</p></footer>
  </main>;
}
